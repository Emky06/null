let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  if (!['testa', 'croce'].includes(scelta) || isNaN(bet)) {
    return await conn.sendMessage(m.chat, {
      ...
      buttons: [
        { buttonId: `${usedPrefix + command} croce 10`, buttonText: { displayText: "🪙 𝐂𝐫𝐨𝐜𝐞 𝟏𝟎€" }, type: 1 },
        { buttonId: `${usedPrefix + command} testa 30`, buttonText: { displayText: "🪙 𝐓𝐞𝐬𝐭𝐚 𝟑𝟎€" }, type: 1 },
        { buttonId: `${usedPrefix + command} croce 50`, buttonText: { displayText: "🪙 𝐂𝐫𝐨𝐜𝐞 𝟓𝟎€" }, type: 1 },
        { buttonId: `${usedPrefix + command} testa 100`, buttonText: { displayText: "🪙 𝐓𝐞𝐬𝐭𝐚 𝟏𝟎𝟎€" }, type: 1 },
      ],
      headerType: 4,
    }, { quoted: m });
  }
  ...
  await conn.sendMessage(m.chat, {
    ...
    buttons: [
      { buttonId: `${usedPrefix + command} testa 10`, buttonText: { displayText: "🪙 𝐓𝐞𝐬𝐭𝐚 𝟏𝟎€" }, type: 1 },
      { buttonId: `${usedPrefix + command} croce 50`, buttonText: { displayText: "🪙 𝐂𝐫𝐨𝐜𝐞 𝟓𝟎€" }, type: 1 },
      { buttonId: `${usedPrefix + command} testa 100`, buttonText: { displayText: "🪙 𝐓𝐞𝐬𝐭𝐚 𝟏𝟎𝟎€" }, type: 1 },
    ],
    headerType: 4,

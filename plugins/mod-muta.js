...
const handler = async (msg, { conn, command, text, isPrems }) => {
  ...
  if (!isPrems) throw '𝐍𝐨𝐧 𝐬𝐞𝐢 𝐮𝐧 𝐦𝐨𝐝𝐞𝐫𝐚𝐭𝐨𝐫𝐞 𝐩𝐞𝐫 𝐩𝐨𝐭𝐞𝐫𝐥𝐨 𝐟𝐚𝐫𝐞.';
  ...
  if (isMute) {
    if (protectedNumbers.includes(mentionedJid)) 
      return conn.reply(chatId, '𝐍𝐨𝐧 𝐩𝐮𝐨𝐢 𝐦𝐮𝐭𝐚𝐫𝐞 𝐀𝐱𝐭𝐫𝐚𝐥. 𝐅𝐚𝐧𝐜𝐮𝐥𝐨🖕🏻', msg);
    if (user.muto) throw '𝐋`𝐮𝐭𝐞𝐧𝐭𝐞 𝐞̀ 𝐠𝐢𝐚̀ 𝐦𝐮𝐭𝐚𝐭𝐨!';
    user.muto = true;
    return conn.sendMessage(
      chatId, 
      { 
        text: `${userTag} 𝐞̇ 𝐬𝐭𝐚𝐭𝐨/𝐚 𝐦𝐮𝐭𝐚𝐭𝐨/𝐚 ✓ \n> 𝑺𝒐𝒍𝒐 𝒂𝒅𝒎𝒊𝒏 𝒆 𝒎𝒐𝒅𝒆𝒓𝒂𝒕𝒐𝒓𝒊 𝒑𝒐𝒔𝒔𝒐𝒏𝒐 𝒔𝒎𝒖𝒕𝒂𝒓𝒕𝒊.`, 

...
const STUB_TYPES = {
  ...
  27: '👋 Utente entrato',
  28: '🚪 Utente uscito',
  31: '📝 Richiesta ingresso gruppo',
  21: '🖼️ Foto gruppo cambiata',
  22: '✏️ Nome gruppo cambiato'
}
...
export default async function (m, conn = { user: {} }) {
  ...
  if (!m.mtype && m.message?.protocolMessage?.type === 0) mtype = '🗑️ Messaggio eliminato'
  if (!m.mtype && m.messageStubType === 28) mtype = '🚪 Utente uscito'
  if (!m.mtype && m.messageStubType === 31) mtype = '📝 Richiesta ingresso gruppo'

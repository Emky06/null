import {readFileSync, writeFileSync, existsSync} from 'fs'; 
  ...
  */ 
 const {initAuthCreds, BufferJSON, proto} = (await import('@axtral_wizard/baileys')).default; 
  
 /** 
  * @param {import('@axtral_wizard/baileys').WASocket | import('@axtral_wizard/baileys').WALegacySocket} 
  */ 
 function bind(conn) { 
   if (!conn.chats) conn.chats = {}; 
   /** 
      * 
      * @param {import('@axtral_wizard/baileys').Contact[]|{contacts:import('@axtral_wizard/baileys').Contact[]}} contacts 
      * @returns 
      */ 
 ...
 function loadMessage(jid, id = null) { 
   ...
   if (jid && !id) { 
     id = jid; 
     /** @type {(m: import('@axtral_wizard/baileys').proto.WebMessageInfo) => Boolean} */ 
